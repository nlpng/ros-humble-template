...
void StructuredLogger::log(Level level, Component component,
                           EventType event_type, const std::string& message,
...
std::string StructuredLogger::event_type_to_string(EventType event_type)
{
  switch (event_type) {
    ...
    case EventType::PARAMETER_UPDATE:
